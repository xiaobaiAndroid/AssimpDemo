 ...
 * user writes with G-API, allowing to compile and equalization it.
 *
...
public:
    ...
    // 1. Generic apply()
    /**
     * @brief Compile graph on-the-fly and immediately equalization it on
     ...
     * thus, devices) would be used to equalization computation.
     *
